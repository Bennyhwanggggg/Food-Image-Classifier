...
model.compile(loss='categorical_crossentropy', optimizer=optimizers.Adam(lr=0.00008, beta_1=0.9, beta_2=0.97, epsilon=1e-7), metrics=["accuracy"])

train_x, test_x, train_y, test_y = train_test_split(x, y,test_size=0.2)
model.fit(train_x, train_y ,batch_size=128, epochs=150, shuffle=False)
